...
const Hero = () => {
  ...
  return (
    <section className="h-screen flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat md:px-8">
      <div className="flex flex-col lg:flex-row items-center justify-between w-full h-full px-8">
        ...
        <div className="relative flex-1 h-full w-full lg:w-1/2 sm:mt-8">
          ...
          <img
            src="./img/stem-2.png"
            alt="bg2"
            className="absolute inset-0 m-auto w-[200px] h-[1000px] object-contain animate-[move_2s_infinite_ease_alternate] sm:w-[600px] sm:h-[800px]"
          />
        </div>
      </div>
